...
//! Values from H.264 spec Tables 9-12 through 9-23.
//! Each entry is (m, n) where state = clip(2 * ((m * QP) >> 4) + n - 127, 1, 126).
#[allow(unused_imports)]
use crate::prelude::*;

#[rustfmt::skip]
pub static CABAC_CONTEXT_INIT_I: [[i8; 2]; 1024] = [
...
#[rustfmt::skip]
pub static CABAC_CONTEXT_INIT_PB: [[[i8; 2]; 1024]; 3] = [
    [
        [20,-15], [2,54], [3,74], [20,-15], [2,54], [3,74], [-28,127], [-23,104],
